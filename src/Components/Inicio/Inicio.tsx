            ...
            <div className="max-w-tela-desk w-full h-900 flex items-center justify-between m-auto">
                <div className='max-w-texto-inicio w-full'>
                    <h1 className="text-c0 text-4xl font-titulo text-38" id='titulo'>Olá, eu sou <br /> Thiago Marins 👋 <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-e4 to-e2 text-32">Desenvolvedor Full-Stack</span>
                    </h1>
                    <p className="text-c1 font-texto max-w-texto-inicio text-18">Olá, eu sou Thiago Marins, desenvolvedor full-stack com conhecimentos sólidos em <strong>JavaScript</strong>, <strong>React JS</strong>. Tenho alta capacidade de aprender coisas novas e estou sempre em busca de aprimoramento.</p>
